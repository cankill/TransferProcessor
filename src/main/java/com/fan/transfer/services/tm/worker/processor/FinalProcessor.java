...
@Slf4j
public abstract class FinalProcessor <T extends FinalCommand> implements Processor<T> {
    ...
    public FinalProcessor (Repository<Transaction.Id, Transaction> transactionRepository,
    ...
    protected abstract TransactionStatus hintTransactionStatus ();
